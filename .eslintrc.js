module.exports = {
  ...
  "rules": {
      ...
      "@typescript-eslint/naming-convention": [
        ...
        {
          selector: "memberLike", modifiers: ["readonly"], format: ["UPPER_CASE"], leadingUnderscore: 'forbid', trailingUnderscore: 'forbid'
        },
        {
        ...
        {
          selector: 'objectLiteralProperty', format: ['UPPER_CASE', 'camelCase']
        },
        {
        ...
        {
          selector: "typeParameter", format: ["PascalCase"],  prefix: ["T_", "T"]
        },
        {
